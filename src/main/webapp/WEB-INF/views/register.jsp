              ...
              <div class="col-lg-5 col-md-8">
                <div class="d-flex flex-column regis-wrapper">
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="profile.first_name" type="text" name="first_name" placeholder="Kim" class="form-control" id="fname" />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="profile.last_name" type="text" name="last_name" placeholder="Jennie" class="form-control" id="lname" />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="profile.country" type="text" name="country" placeholder="South Korea" class="form-control" id="country" />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="profile.city" type="text" name="city" placeholder="Seoul" class="form-control" id="city" />
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <form:input path="email" type="text" style="${error}" name="email" placeholder="kimjennie@gmail.com" class="form-control" id="email" />
                  </div>
